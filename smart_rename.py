...
def smart_rename():
    ...
    month_map = {
        # 1月
        'jan': '01', 'january': '01', 'ja': '01',
        # 2月
        'feb': '02', 'february': '02', 'fe': '02',
        # 3月
        'mar': '03', 'march': '03', 'mr': '03', # 使用 MR 表示 3 月
        # 4月
        'apr': '04', 'april': '04', 'ap': '04',
        # 5月
        'may': '05', 'ma': '05', # 使用 MA 表示 5 月
        # 6月
        'jun': '06', 'june': '06', 'ju': '06', # 使用 JU 表示 6 月
        # 7月
        'jul': '07', 'july': '07', 'jl': '07', # 使用 JL 表示 7 月
        # 8月
        'aug': '08', 'august': '08', 'au': '08',
        # 9月
        'sep': '09', 'september': '09', 'se': '09',
        # 10月
        'oct': '10', 'october': '10', 'oc': '10',
        # 11月
        'nov': '11', 'november': '11', 'no': '11',
        # 12月
        'dec': '12', 'december': '12', 'de': '12'
    }
